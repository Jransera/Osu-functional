...
var $author$project$Osu$audio = F2(
	function (_v0, model) {
...
var $author$project$Osu$audioPortFromJS = _Platform_incomingPort('audioPortFromJS', $elm$json$Json$Decode$value);
var $author$project$Osu$audioPortToJS = _Platform_outgoingPort('audioPortToJS', $elm$core$Basics$identity);
...
var $author$project$Osu$LoadingModel = {$: 'LoadingModel'};
var $author$project$Osu$SoundLoaded = function (a) {
...
var $author$project$Osu$init = function (_v0) {
	return _Utils_Tuple3(
		$author$project$Osu$LoadingModel,
		$elm$core$Platform$Cmd$none,
...
var $author$project$Osu$LoadFailedModel = {$: 'LoadFailedModel'};
var $author$project$Osu$LoadedModel = function (a) {
	return {$: 'LoadedModel', a: a};
};
var $author$project$Osu$NotPlaying = {$: 'NotPlaying'};
var $author$project$Osu$Playing = function (a) {
	return {$: 'Playing', a: a};
};
var $author$project$Osu$PressedPlayAndGotTime = function (a) {
...
var $author$project$Osu$main = $MartinSStewart$elm_audio$Audio$elementWithAudio(
	{
...
_Platform_export({'Osu':{'init':$author$project$Osu$main(
